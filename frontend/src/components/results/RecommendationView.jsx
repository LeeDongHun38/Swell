      ...
      <div className={`flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 h-full min-h-0 pb-6 fade-transition ${isTransitioning ? 'hidden-state' : ''}`}>
        ...
        <div className="lg:col-span-5 flex flex-col h-full min-h-0 pl-0 lg:pl-4">
          ...
          <div className="mt-4 pt-4 border-t border-slate-200 flex justify-between items-center shrink-0">
            ...
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdGC37x85RxlUI37I_6U0YEHkV8WQwpUPygIrnKoUmwDEFRkQ/viewform?usp=header"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-5 py-2.5 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-bold rounded-full shadow-lg hover:shadow-xl transition-all animate-bounce-subtle"
            >
              <span>서비스 평가하기</span>
